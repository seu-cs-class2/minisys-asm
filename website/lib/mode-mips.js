...
var MIPSHighlightRules = function() {
    ...
    this.$rules = {
        start: [{
            ...
            regex: /\b(?:add|addu|addi|addiu|sub|subu|and|andi|or|not|ori|nor|xor|xori|slt|sltu|slti|sltiu|sll|sllv|rol|srl|sra|srlv|ror|j|jr|jal|jalr|beq|bne|lw|sw|lb|lbu|lh|lhu|sh|sb|lui|move|mfhi|mflo|mthi|mtlo|mfc0|mtc0|nop|push|pop|jl|jle|jg|jge|bgez|bgtz|blez|bltz|bgezal|bltzal|break|syscall|eret)\b/,
